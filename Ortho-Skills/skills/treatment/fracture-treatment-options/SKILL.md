# Skill: Fracture Treatment Options
...
Generate a structured, non-prescriptive list of plausible nonoperative and operative treatment option categories for clinician review.
...
1. Confirm classification status.
2. List plausible treatment categories without prescribing.
3. State key decision factors.
4. Identify evidence gaps and missing data.
5. Flag red flags and urgent referral criteria.
6. Return a clinician-review checklist.
...
```yaml
skill_output:
  skill_id: "fracture-treatment-options"
...
```text
Use the Fracture Treatment Options skill for this orthopaedic case. Provide a structured draft output and state uncertainty.
```
