# Skill: Implant Selection Factors
...
Structure clinical, anatomical, biomechanical, patient, and institutional factors that influence implant selection without prescribing a specific implant.
...
1. Start from confirmed injury pattern and treatment goal.
2. List anatomical and biomechanical factors.
3. List patient factors such as bone quality and functional demand.
4. List procedure and institution factors.
5. List implant traceability fields needed if implant is used.
6. Avoid recommending a specific commercial product unless context supports it.
...
```yaml
skill_output:
  skill_id: "implant-selection-factors"
...
```text
Use the Implant Selection Factors skill for this orthopaedic case. Provide a structured draft output and state uncertainty.
```
