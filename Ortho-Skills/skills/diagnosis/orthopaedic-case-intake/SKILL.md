...
Capture the minimum structured case context needed before image review, fracture classification, treatment planning, documentation, and follow-up.
...
1. Create a new case identifier.
2. Collect patient age group, mechanism, injury time, region, laterality, and clinical question.
3. Collect imaging type and view labels.
4. Check for red flags.
5. De-identify input before downstream processing.
6. Route to image quality, classification, or workup planning.
...
```yaml
skill_output:
  skill_id: "orthopaedic-case-intake"
...
```text
Use the Orthopaedic Case Intake skill for this orthopaedic case. Provide a structured draft output and state uncertainty.
```
