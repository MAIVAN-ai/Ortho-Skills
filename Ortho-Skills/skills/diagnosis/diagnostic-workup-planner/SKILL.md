# Skill: Diagnostic Workup Planner
...
Suggest additional views, CT, MRI, history, examination findings, or operative information required before classification or treatment planning.
...
1. Read clinical question and available data.
2. Identify missing diagnostic information.
3. Map missing data to imaging, history, examination, labs, or operative findings.
4. Prioritise required before optional information.
5. Avoid treatment planning until diagnostic uncertainty is stated.
...
```yaml
skill_output:
  skill_id: "diagnostic-workup-planner"
...
```text
Use the Diagnostic Workup Planner skill for this orthopaedic case. Provide a structured draft output and state uncertainty.
```
