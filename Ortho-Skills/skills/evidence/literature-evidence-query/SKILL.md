# Skill: Literature Evidence Query

## Skill ID

`literature-evidence-query`
...
Generate precise literature-search queries and evidence summaries for orthopaedic diagnosis, treatment, complications, outcomes, and PMCF questions.
...
1. Define PICO or clinical evidence question.
2. Generate search queries for PubMed/Consensus/Google Scholar or institutional tools.
3. Prioritise systematic reviews, guidelines, trials, registries, and high-quality cohort studies.
4. Summarise evidence boundaries.
5. Avoid fabricating citations.
...
```yaml
skill_output:
  skill_id: "literature-evidence-query"
...
```text
Use the Literature Evidence Query skill for this orthopaedic case. Provide a structured draft output and state uncertainty.
```
