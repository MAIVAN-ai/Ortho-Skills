# Skill: Aftercare and Rehabilitation Plan

## Skill ID

`aftercare-rehabilitation-plan`
...
Create a draft aftercare and rehabilitation checklist based on injury type, treatment category, restrictions, follow-up milestones, and clinician review.
...
1. Receive treatment category and surgeon restrictions.
2. Structure weight-bearing, immobilisation, wound care, physiotherapy, imaging follow-up, and return-to-work/sport questions.
3. State that local protocol and surgeon instructions override draft output.
4. Flag complications requiring review.
5. Prepare patient-friendly and clinician versions if requested.
...
```yaml
skill_output:
  skill_id: "aftercare-rehabilitation-plan"
...
```text
Use the Aftercare and Rehabilitation Plan skill for this orthopaedic case. Provide a structured draft output and state uncertainty.
```
