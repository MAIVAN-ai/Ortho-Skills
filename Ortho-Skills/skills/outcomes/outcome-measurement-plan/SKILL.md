# Skill: Outcome Measurement Plan
...
Define outcome measures, timepoints, complications, radiographic endpoints, and patient-reported outcomes for an orthopaedic case or cohort.
...
1. Define clinical outcome objectives.
2. Select PROMs and clinician-reported outcomes appropriate to region.
3. Define radiographic healing or alignment endpoints.
4. Define complications and reoperation tracking.
5. Set follow-up timepoints.
6. Prepare registry-ready fields.
...
```yaml
skill_output:
  skill_id: "outcome-measurement-plan"
...
```text
Use the Outcome Measurement Plan skill for this orthopaedic case. Provide a structured draft output and state uncertainty.
```
