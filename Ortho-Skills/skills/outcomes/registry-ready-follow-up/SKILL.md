# Skill: Registry-Ready Follow-up

## Skill ID

`registry-ready-follow-up`
...
Convert follow-up information into structured fields suitable for registries, real-world evidence, PMCF, and outcomes analysis.
...
1. Receive follow-up note, image, PROM, or complication data.
2. Map data to structured registry fields.
3. Record completeness and uncertainty.
4. Flag missing outcome or implant fields.
5. Prepare longitudinal case capsule update.
...
```yaml
skill_output:
  skill_id: "registry-ready-follow-up"
...
```text
Use the Registry-Ready Follow-up skill for this orthopaedic case. Provide a structured draft output and state uncertainty.
```
