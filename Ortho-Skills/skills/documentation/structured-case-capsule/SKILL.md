...
Create an auditable, de-identified orthopaedic case capsule linking images, classification, treatment, implant data, outcomes, aftercare, and confirmations.
...
1. Create a de-identified case summary.
2. Link images, reports, classification, treatment, implant data, aftercare, and outcomes.
3. Separate AI draft outputs from surgeon-confirmed facts.
4. Record audit trail and versioning.
5. Prepare export for registry, PMCF, education, or case report.
...
```yaml
skill_output:
  skill_id: "structured-case-capsule"
...
## Case Capsule Principle

Separate all AI-generated draft artefacts from clinician-confirmed facts.

```yaml
case_capsule:
  ai_draft_layer: []
  surgeon_confirmed_layer: []
  audit_layer: []
  evidence_layer: []
  outcome_layer: []
```
...
```text
Use the Structured Case Capsule skill for this orthopaedic case. Provide a structured draft output and state uncertainty.
```
