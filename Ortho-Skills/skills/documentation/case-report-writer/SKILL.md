# Skill: Orthopaedic Case Report Writer
...
Transform confirmed case-capsule data into a draft case report, educational vignette, or journal-style narrative while preserving uncertainty and source boundaries.
...
1. Use only de-identified, confirmed case-capsule information.
2. Draft title, abstract, introduction, case presentation, management, outcome, discussion, and learning points.
3. Separate facts from interpretation.
4. Add citation placeholders rather than inventing references.
5. Mark publication-readiness gaps.
...
```text
Use the Orthopaedic Case Report Writer skill for this orthopaedic case. Provide a structured draft output and state uncertainty.
```
