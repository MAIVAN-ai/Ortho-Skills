# Skill: Paediatric Fracture Triage

## Skill ID

`paediatric-fracture-triage`
...
Detect when a case may require paediatric fracture classification, physeal-injury reasoning, or paediatric orthopaedic review rather than adult AO/OTA coding.
...
1. Assess skeletal maturity indicators.
2. Check whether growth plates are visible or relevant.
3. Identify possible physeal or paediatric-specific patterns.
4. Flag when adult AO/OTA classification may be inappropriate.
5. Route to paediatric orthopaedic review.
...
```yaml
skill_output:
  skill_id: "paediatric-fracture-triage"
...
```text
Use the Paediatric Fracture Triage skill for this orthopaedic case. Provide a structured draft output and state uncertainty.
```
