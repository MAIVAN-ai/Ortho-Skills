# Skill: Periprosthetic Fracture Triage

## Skill ID

`periprosthetic-fracture-triage`
...
Detect suspected periprosthetic fractures and route them toward periprosthetic classification, implant stability assessment, and specialist review.
...
1. Detect arthroplasty, plate, nail, screw, or other implant.
2. Determine whether fracture is around or near implant.
3. Assess whether implant stability can be inferred or requires clinical data.
4. Flag need for periprosthetic classification.
5. Route implant metadata to traceability record.
...
```yaml
skill_output:
  skill_id: "periprosthetic-fracture-triage"
...
```text
Use the Periprosthetic Fracture Triage skill for this orthopaedic case. Provide a structured draft output and state uncertainty.
```
