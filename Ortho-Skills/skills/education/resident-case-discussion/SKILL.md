# Skill: Resident Case Discussion
...
Convert a structured orthopaedic case into a teaching discussion for residents, including classification reasoning, treatment options, pitfalls, and follow-up questions.
...
2. Ask learner to identify anatomy, view, and fracture pattern.
3. Walk through classification logic.
4. Discuss treatment-option factors.
5. Highlight pitfalls and red flags.
6. End with follow-up and outcome questions.
...
```yaml
skill_output:
  skill_id: "resident-case-discussion"
...
```text
Use the Resident Case Discussion skill for this orthopaedic case. Provide a structured draft output and state uncertainty.
```
