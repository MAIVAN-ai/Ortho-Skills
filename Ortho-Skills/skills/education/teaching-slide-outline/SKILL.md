...
Create a slide-by-slide outline for orthopaedic case teaching using confirmed classification, imaging findings, treatment, outcome, and learning points.
...
1. Create slide objectives.
2. Outline case intro, imaging, classification, treatment decision, procedure, aftercare, outcome, and learning points.
3. Include speaker notes prompts.
4. Flag images requiring consent/de-identification.
5. Avoid claiming publication permission for clinical images.
...
```yaml
skill_output:
  skill_id: "teaching-slide-outline"
...
```text
Use the Teaching Slide Outline skill for this orthopaedic case. Provide a structured draft output and state uncertainty.
```
